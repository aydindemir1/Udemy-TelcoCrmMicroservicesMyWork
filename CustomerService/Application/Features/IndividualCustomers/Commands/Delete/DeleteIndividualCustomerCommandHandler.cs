...
{
    public class DeleteIndividualCustomerCommandHandler : ICommandHandler<DeleteIndividualCustomerCommand>
    {
        private readonly IIndividualCustomerRepository _individualCustomerRepository;
        private readonly IUnitOfWork _unitOfWork;

        public DeleteIndividualCustomerCommandHandler(IIndividualCustomerRepository individualCustomerRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Unit> Handle(DeleteIndividualCustomerCommand request, CancellationToken cancellationToken)
        {
            ...
            await _individualCustomerRepository.DeleteAsync(individualCustomer, permanent: true);
